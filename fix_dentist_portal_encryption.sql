-- ============================================================================
-- FIX: Dentist Portal Encryption - Apply Missing Migrations
-- ============================================================================
-- This script creates the secure_profiles_view with proper decryption
...
-- Step 2: Create the secure_profiles_view with proper decryption
...
-- SELECT id, first_name, last_name, email FROM public.secure_profiles_view LIMIT 5;
-- ============================================================================
