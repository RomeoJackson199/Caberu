  ...
  return (
    <Card className="w-full max-w-md mx-auto bg-[hsl(var(--component-bg))] border-0 border-t border-[hsl(var(--component-border))] rounded-3xl">
      <CardHeader>
        ...
        <h2 className="text-[hsl(var(--component-text))] text-base font-medium mb-2">Sign in to Components</h2>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="relative">
          <Input id="password" type={showPassword ? "text" : "password"} placeholder="Enter your password" className="pr-10" />
