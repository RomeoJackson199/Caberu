  ...
  return (
    <Card className="w-full max-w-md mx-auto bg-[hsl(var(--component-bg))] border-0 border-t border-[hsl(var(--component-border))] rounded-3xl">
      <CardHeader>
        ...
        <h2 className="text-[hsl(var(--component-text))] text-base font-medium mb-2">Reset your password</h2>
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          <button
            className="w-full h-10 text-white rounded-xl font-medium transition-colors bg-[hsl(var(--auth-button-bg))] hover:bg-[hsl(var(--auth-button-hover))]"
          >
            Send Reset Link
          </button>
        </div>
