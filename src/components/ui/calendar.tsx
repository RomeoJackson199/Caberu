    ...
    <DayPicker
      ...
      classNames={{
        ...
        day_button: cn(
          ...
          "h-10 w-10 p-0 font-normal rounded-xl hover:bg-primary/10 transition-colors aria-selected:opacity-100"
        ),
        range_end: "day-range-end",
        selected:
          "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground rounded-xl font-semibold shadow-sm",
        today: "bg-accent text-accent-foreground rounded-xl font-semibold",
        outside:
