...
import { LayoutDashboard, Users, Calendar, UserCog, Settings as SettingsIcon, LogOut, MessageSquare, ChevronDown, Bell, CalendarDays } from "lucide-react";
...
export type DentistSection = 'dashboard' | 'patients' | 'appointments' | 'employees' | 'messages' | 'clinical' | 'schedule' | 'google-calendar' | 'analytics' | 'reports' | 'imports' | 'branding' | 'security' | 'users' | 'team' | 'settings' | 'services' | 'admin-analytics';
...
export const DentistAppShell: React.FC<DentistAppShellProps> = ({
  ...
  const allNavItems = useMemo(() => [{
    ...
    id: 'google-calendar' as DentistSection,
    label: 'Google Calendar',
    icon: CalendarDays,
    path: '/dentist/google-calendar'
  }], [t]);
