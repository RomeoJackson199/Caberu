...
export const VideoShowcase: React.FC = () => {
  return (
    <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
            Watch how Caberu transforms dental practice management with AI-powered tools
          </p>
        </div>
