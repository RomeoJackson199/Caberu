...
export function CompletionDialog({
  ...
  // Quick add treatments based on fetched services
  const quickTreatments = dbServices.map(s => ({
    name: s.name,
        ...
        return (
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Link this appointment to an existing treatment plan or create a new one
              </p>
            </div>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (!e.target.checked) {
                      setSelectedTreatmentPlan(null);
                      setCreateNewTreatmentPlan(false);
                    }
                  }}
                  className="w-4 h-4"
                />
                <Label htmlFor="link-treatment-plan">Link to a Treatment Plan</Label>
              </div>
                ...
                <div className="ml-6 space-y-4 p-4 bg-muted/30 rounded-lg">
                  ...
                  {treatmentPlans.length > 0 && !createNewTreatmentPlan && (
                    <div className="space-y-2">
                      ...
                      <Select
                        value={selectedTreatmentPlan || ''}
                        onValueChange={(v) => setSelectedTreatmentPlan(v)}
                      >
                        <SelectTrigger>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => {
                        setCreateNewTreatmentPlan(e.target.checked);
                        if (e.target.checked) setSelectedTreatmentPlan(null);
                      }}
                      className="w-4 h-4"
                    />
                    <Label htmlFor="create-new-plan">Create new treatment plan</Label>
                  </div>
                    ...
                    <div className="space-y-4 pt-2">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          value={newTreatmentPlanForm.diagnosis}
                          onChange={(e) => setNewTreatmentPlanForm(prev => ({ ...prev, diagnosis: e.target.value }))}
                          placeholder="e.g., Pulpitis on tooth #14"
                        />
                      </div>
                      <div>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">Complete the appointment workflow step by step.</DialogDescription>
        </DialogHeader>
