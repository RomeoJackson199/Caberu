...
const SAMPLE_DATA: Partial<Prospect>[] = [
  { name: "Tandartspraktijk Dr. Hermans", address: "Bondgenotenlaan 14, 3000 Leuven", phone: "+32 16 22 11 45", website: "", rating: 4.1, reviewCount: 38, dentistCount: 1, languages: ["Dutch"], onlineBooking: false, priority: "Hot", receptionSignal: "3 reviews mention missed calls and long phone waits", notes: "Solo practice. Website from 2018. No patient portal. Strong Caberu candidate.", lat: 50.879, lng: 4.703, contactName: "Dr. Hermans", contactRole: "Owner / Solo Dentist", painPoints: ["Missed calls", "No patient portal", "Outdated website"] },
  { name: "Dental Studio Tienen", address: "Leuvensestraat 88, 3300 Tienen", phone: "+32 16 81 55 22", website: "https://example.be", rating: 4.4, reviewCount: 72, dentistCount: 2, languages: ["Dutch", "French"], onlineBooking: false, priority: "Hot", receptionSignal: "Reviews say they struggle to reach the practice by phone", notes: "2 dentists, bilingual. No booking system despite 70+ reviews.", lat: 50.800, lng: 4.940, contactName: "Unknown", painPoints: ["Unreachable by phone", "No booking system"] },
  { name: "Tandarts Van Acker", address: "Stationsstraat 5, 3200 Aarschot", phone: "+32 16 56 77 10", website: "", rating: 3.9, reviewCount: 21, dentistCount: 1, languages: ["Dutch"], onlineBooking: false, priority: "Hot", receptionSignal: "No digital presence detected", notes: "Solo practice, no website. Relies 100% on phone calls.", lat: 51.000, lng: 4.833, painPoints: ["Zero digital presence", "Phone-only booking"] },
  ...
  { name: "Tandarts Rotselaar", address: "Provinciebaan 22, 3110 Rotselaar", phone: "+32 16 44 11 20", website: "", rating: 4.0, reviewCount: 18, dentistCount: 1, languages: ["Dutch"], onlineBooking: false, priority: "Hot", receptionSignal: "No digital presence at all", notes: "Solo practice in Rotselaar. No website found. Manual booking only.", lat: 50.957, lng: 4.717, painPoints: ["No digital presence", "Manual booking only"] },
...
export function ImportModal({ onImport, onClose }: ImportModalProps) {
  ...
  const handleImport = () => {
    try {
      ...
      const prospects: Prospect[] = data.map((item: any) => ({
  ...
  const handleLoadSample = () => {
    const full = SAMPLE_DATA.map(s => ({ ...DEFAULT_PROSPECT_FIELDS, ...s }));
      ...
      <div className="w-[600px] max-h-[80vh] flex flex-col rounded-xl" style={{ background: '#0d1220', border: '1px solid #1c2540' }}>
        <div className="flex items-center justify-between p-5 pb-3">
          <div>
            ...
            <p className="text-[10px] mt-1" style={{ color: '#56688e' }}>
              New fields: contactName, contactRole, contactPersonality, painPoints, visitDate, talkTrack, status
            </p>
          </div>
        ...
        <div className="px-5 flex-1 overflow-hidden">
          <textarea
            ...
            placeholder='[{"name": "...", "lat": 50.88, "lng": 4.70, "contactName": "Dr. X", "painPoints": ["missed calls"], ...}]'
