-- Fix signup: Default role_type to 'patient' instead of 'owner'
-- This prevents accidentally creating business/dentist records for OAuth signups
-- where role_type is not explicitly passed
